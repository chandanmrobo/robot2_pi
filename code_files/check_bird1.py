...
for idx, (img_path, has_bird, detected, conf) in enumerate(test_samples):
...
plt.suptitle("Bird Model — Sample Predictions (Green=Correct, Red=Wrong)", fontsize=22, fontweight="bold", y=1.01)
